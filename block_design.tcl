...
create_bd_port -dir O -from 0 -to 0 Ext_trigger
...
create_bd_cell -type ip -vlnv PSFC:user:scaler:1.0 scaler_Current


create_bd_cell -type ip -vlnv PSFC:user:scaler:1.0 scaler_LB


create_bd_cell -type ip -vlnv PSFC:user:manual_calibration:1.0 Calibrate_Output
create_bd_cell -type ip -vlnv PSFC:user:output_mux:1.0 Save_mux_LB
create_bd_cell -type ip -vlnv PSFC:user:output_mux:1.0 Save_mux_PC


#############################################################################################################
connect_bd_net [get_bd_ports Ext_trigger] [get_bd_pins acquire_trigger/clear_pulse]
...
set_property -dict [list CONFIG.Write_Width_A {16} CONFIG.Write_Depth_A {8192} CONFIG.Read_Width_A {16}] [get_bd_cells iSat_SPR]
...
set_property -dict [list CONFIG.Load_Init_File {true} CONFIG.Coe_File {/home1/william/Koheron/koheron-sdk/instruments/mirror-langmuir-probe-DIONISOS/cores/isat_calc_v1_0/iSat_lut.coe}] [get_bd_cells iSat_SPR]
...
set_property -dict [list CONFIG.latency {30}] [get_bd_cells vFloat_div]
...
set_property -dict [list CONFIG.Load_Init_File {true} CONFIG.Coe_File {/home1/william/Koheron/koheron-sdk/instruments/mirror-langmuir-probe-DIONISOS/cores/vfloat_calc_v1_0/vFloat_lut.coe}] [get_bd_cells vFloat_SPR]
...
connect_bd_net [get_bd_pins ctl/lower_temp_lim] [get_bd_pins Temp_calc/Temp_lower_lim]
connect_bd_net [get_bd_pins ctl/upper_temp_lim] [get_bd_pins Temp_calc/Temp_upper_lim]
...
set_property -dict [list CONFIG.Load_Init_File {true} CONFIG.Coe_File {/home1/william/Koheron/koheron-sdk/instruments/mirror-langmuir-probe-DIONISOS/cores/temp_calc_v1_0/Temp_lut.coe}] [get_bd_cells Temp_SPR]
...
connect_bd_net [get_bd_pins output_slice/din] [get_bd_pins ctl/Const_voltage]
...
connect_bd_net [get_bd_pins scaler_LB/signal_to_scale] [get_bd_pins calibrate_LB/volt_out]
connect_bd_net [get_bd_pins calibrate_LB/volt_in] [get_bd_pins adc_dac/adc2]
...
connect_bd_net [get_bd_pins scaler_Current/signal_to_scale] [get_bd_pins calibrate_PC/volt_out]
...
connect_bd_net [get_bd_pins calibrate_PC/volt_in] [get_bd_pins adc_dac/adc1]


connect_bd_net [get_bd_pins calibrate_PC/volt_out] [get_bd_pins sts/Volt_1]
connect_bd_net [get_bd_pins calibrate_LB/volt_out] [get_bd_pins sts/Volt_2]
##################################################################################################################
...
connect_bd_net [get_bd_pins moving_average_LB/volt_out] [get_bd_pins iSat_calc/LB_Voltage]
connect_bd_net [get_bd_pins moving_average_LB/volt_out] [get_bd_pins Temp_calc/LB_Voltage]
connect_bd_net [get_bd_pins moving_average_LB/volt_out] [get_bd_pins vFloat_calc/LB_Voltage]

connect_bd_net [get_bd_pins moving_average_PC/volt_out] [get_bd_pins iSat_calc/LP_current]
connect_bd_net [get_bd_pins moving_average_PC/volt_out] [get_bd_pins Temp_calc/LP_current]
connect_bd_net [get_bd_pins moving_average_PC/volt_out] [get_bd_pins vFloat_calc/LP_current]
##################################################################################################################
...
connect_bd_net [get_bd_pins data_collector/store_en] [get_bd_pins set_voltage/store_en]
...
connect_bd_net [get_bd_pins ctl/Trigger] [get_bd_pins acquire_trigger/trigger]
...
connect_bd_net [get_bd_pins ctl/Const_switch] [get_bd_pins trigger_to_mux/din]

connect_bd_net [get_bd_pins output_mux/signal_out] [get_bd_pins Calibrate_Output/volt_in]
##################################################################################################################
...
#################################################################################################################
# Connecting the input scaling blocks
connect_bd_net [get_bd_pins scaler_Current/adc_clk] [get_bd_pins adc_dac/adc_clk]
connect_bd_net [get_bd_pins scaler_LB/adc_clk] [get_bd_pins adc_dac/adc_clk]

connect_bd_net [get_bd_pins scaler_Current/Scaled_signal] [get_bd_pins moving_average_PC/volt_in]
connect_bd_net [get_bd_pins scaler_LB/Scaled_signal] [get_bd_pins moving_average_LB/volt_in]
...
##################################################################################################################
#Calibration of the output Voltage

connect_bd_net [get_bd_pins Calibrate_Output/adc_clk] [get_bd_pins adc_dac/adc_clk]
connect_bd_net [get_bd_pins Calibrate_Output/clk_rst] [get_bd_pins acquire_trigger/clear_pulse]
connect_bd_net [get_bd_pins Calibrate_Output/scale] [get_bd_pins ctl/Scale_Out]
connect_bd_net [get_bd_pins Calibrate_Output/offset] [get_bd_pins ctl/Offset_Out]


connect_bd_net [get_bd_pins Calibrate_Output/volt_out] [get_bd_pins adc_dac/dac1]
connect_bd_net [get_bd_pins Temp_calc/Temp] [get_bd_pins adc_dac/dac2]


###################################################################################################################

###################################################################################################################
#Connected muxes for the input calibration mode
connect_bd_net [get_bd_pins Save_mux_PC/adc_clk] [get_bd_pins adc_dac/adc_clk]
connect_bd_net [get_bd_pins Save_mux_LB/adc_clk] [get_bd_pins adc_dac/adc_clk]

connect_bd_net [get_bd_pins Save_mux_LB/signal_2] [get_bd_pins calibrate_LB/volt_out]
connect_bd_net [get_bd_pins Save_mux_PC/signal_2] [get_bd_pins calibrate_PC/volt_out]
connect_bd_net [get_bd_pins trigger_to_mux/Dout] [get_bd_pins Save_mux_PC/switch]
connect_bd_net [get_bd_pins trigger_to_mux/Dout] [get_bd_pins Save_mux_LB/switch]
connect_bd_net [get_bd_pins Save_mux_LB/signal_out] [get_bd_pins data_collector/v_out]
connect_bd_net [get_bd_pins Save_mux_PC/signal_out] [get_bd_pins data_collector/v_in]

connect_bd_net [get_bd_pins moving_average_PC/volt_out] [get_bd_pins Save_mux_PC/signal_1]
connect_bd_net [get_bd_pins moving_average_LB/volt_out] [get_bd_pins Save_mux_LB/signal_1]
###################################################################################################################


####################################### LED Connector (needed to operate koheron) ########################################################
