...
# module references:
# DataCollect, SetVolts, TempCalc, iSatCalc, vFloatCalc
...
proc create_root_design { parentCell } {
  ...
  set Temp_en_out [ create_bd_port -dir O Temp_en_out ]
  ...
  set gen_out [ create_bd_port -dir O -from 12 -to 0 gen_out ]
  set iSat_en_out [ create_bd_port -dir O iSat_en_out ]
  set save_data [ create_bd_port -dir O -from 31 -to 0 save_data ]
  set save_out [ create_bd_port -dir O save_out ]
  set temp_en [ create_bd_port -dir O temp_en ]
  set vFloat_en_out [ create_bd_port -dir O vFloat_en_out ]

  # Create instance: DataCollect_0, and set properties
  set block_name DataCollect
  set block_cell_name DataCollect_0
  if { [catch {set DataCollect_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $DataCollect_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net TempCalc_0_dividend [get_bd_intf_pins TempCalc_0/dividend] [get_bd_intf_pins div_gen_2/S_AXIS_DIVIDEND]
  connect_bd_intf_net -intf_net TempCalc_0_divisor [get_bd_intf_pins TempCalc_0/divisor] [get_bd_intf_pins div_gen_2/S_AXIS_DIVISOR]
  connect_bd_intf_net -intf_net div_gen_0_M_AXIS_DOUT [get_bd_intf_pins div_gen_0/M_AXIS_DOUT] [get_bd_intf_pins iSatCalc_0/divider]
  ...
  connect_bd_intf_net -intf_net div_gen_2_M_AXIS_DOUT [get_bd_intf_pins TempCalc_0/divider] [get_bd_intf_pins div_gen_2/M_AXIS_DOUT]
  connect_bd_intf_net -intf_net iSatCalc_0_dividend [get_bd_intf_pins div_gen_0/S_AXIS_DIVIDEND] [get_bd_intf_pins iSatCalc_0/dividend]
  connect_bd_intf_net -intf_net iSatCalc_0_divisor [get_bd_intf_pins div_gen_0/S_AXIS_DIVISOR] [get_bd_intf_pins iSatCalc_0/divisor]
  ...
  connect_bd_net -net DataCollect_0_tdata [get_bd_ports save_data] [get_bd_pins DataCollect_0/tdata]
  connect_bd_net -net DataCollect_0_tvalid [get_bd_ports save_out] [get_bd_pins DataCollect_0/tvalid]
  connect_bd_net -net LB_Voltage_1 [get_bd_ports LB_Voltage] [get_bd_pins TempCalc_0/LB_Voltage] [get_bd_pins iSatCalc_0/LB_Voltage] [get_bd_pins vFloatCalc_0/LB_Voltage]
  connect_bd_net -net LP_current_1 [get_bd_ports LP_current] [get_bd_pins TempCalc_0/LP_current] [get_bd_pins iSatCalc_0/LP_Current] [get_bd_pins vFloatCalc_0/LP_current]
  connect_bd_net -net Period_in_1 [get_bd_ports Period_in] [get_bd_pins SetVolts_0/period_in]
  connect_bd_net -net SetVolts_0_Temp_en [get_bd_ports Temp_en_out] [get_bd_pins SetVolts_0/Temp_en] [get_bd_pins TempCalc_0/clk_en]
  connect_bd_net -net SetVolts_0_iSat_en [get_bd_ports iSat_en_out] [get_bd_pins SetVolts_0/iSat_en] [get_bd_pins iSatCalc_0/clk_en]
  connect_bd_net -net SetVolts_0_vFloat_en [get_bd_ports vFloat_en_out] [get_bd_pins SetVolts_0/vFloat_en] [get_bd_pins vFloatCalc_0/clk_en]
  ...
  connect_bd_net -net TempCalc_0_Temp [get_bd_ports Temp_out] [get_bd_pins DataCollect_0/Temp] [get_bd_pins SetVolts_0/Temp] [get_bd_pins TempCalc_0/Temp] [get_bd_pins iSatCalc_0/Temp] [get_bd_pins vFloatCalc_0/Temp]
  connect_bd_net -net TempCalc_0_data_valid [get_bd_ports temp_en] [get_bd_pins DataCollect_0/Temp_valid] [get_bd_pins SetVolts_0/Temp_valid] [get_bd_pins TempCalc_0/data_valid]
  ...
  connect_bd_net -net adc_clk_1 [get_bd_ports adc_clk] [get_bd_pins DataCollect_0/adc_clk] [get_bd_pins SetVolts_0/adc_clk] [get_bd_pins TempCalc_0/adc_clk] [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins blk_mem_gen_1/clka] [get_bd_pins blk_mem_gen_2/clka] [get_bd_pins div_gen_0/aclk] [get_bd_pins div_gen_1/aclk] [get_bd_pins div_gen_2/aclk] [get_bd_pins iSatCalc_0/adc_clk] [get_bd_pins vFloatCalc_0/adc_clk]
  connect_bd_net -net blk_mem_gen_0_douta [get_bd_ports blk_out] [get_bd_pins blk_mem_gen_0/douta] [get_bd_pins iSatCalc_0/BRAMret]
  ...
  connect_bd_net -net iSatCalc_0_BRAM_addr [get_bd_ports gen_out] [get_bd_pins blk_mem_gen_0/addra] [get_bd_pins iSatCalc_0/BRAM_addr]
  connect_bd_net -net iSatCalc_0_iSat [get_bd_ports Isat_out] [get_bd_pins DataCollect_0/iSat] [get_bd_pins TempCalc_0/iSat] [get_bd_pins iSatCalc_0/iSat] [get_bd_pins vFloatCalc_0/iSat]
  connect_bd_net -net vFloatCalc_0_BRAM_addr [get_bd_pins blk_mem_gen_2/addra] [get_bd_pins vFloatCalc_0/BRAM_addr]
  connect_bd_net -net vFloatCalc_0_vFloat [get_bd_ports VFloat_out] [get_bd_pins DataCollect_0/vFloat] [get_bd_pins TempCalc_0/vFloat] [get_bd_pins iSatCalc_0/vFloat] [get_bd_pins vFloatCalc_0/vFloat]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins DataCollect_0/clk_en] [get_bd_pins xlconstant_0/dout]
