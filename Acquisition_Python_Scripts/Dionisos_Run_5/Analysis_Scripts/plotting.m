...
plot(Scope_Time_stamp-min(Scope_Time_stamp),Scope_Bias,'b')
plot(Scope_Time_stamp-min(Scope_Time_stamp),Scope_Bias_Request,'g')
...
plot(Scope_Time_stamp-min(Scope_Time_stamp),Scope_Current*1000,'b')
...
plot(Scope_Time_Fit-min(Scope_Time_Fit),Scope_Temp_Fit(1,:),'*','color','b')
plot(Time_Stamp_mlp,Temp_mlp,'*','color','g')
legend('Scope Temp Fit','MLP Temp Calc','MLP Temp Fit')
box on
set(gcf,'color','w');
ylabel('Temp (ev)')
xlabel('Time (\mus)')
...
plot(Scope_Time_Fit-min(Scope_Time_Fit),Scope_Float_Fit(1,:),'*','color','b')
plot(Time_Stamp_mlp,Float_mlp,'*','color','g')
legend('Scope Float Fit','MLP Float Calc','MLP Float Fit')
box on
set(gcf,'color','w');
ylabel('V Float (V)')
xlabel('Time (\mus)')
