...
class MLP(object):
    ...
    @command()
    def set_Const_voltage(self, Const_voltage):
        pass

    @command()
    def set_Const_switch(self, Const_switch):
        pass
    ...
    @command()
    def set_scale_Out(self, scale_Out):
        pass
    ...
    @command()
    def set_offset_Out(self, offset_Out):
        pass
